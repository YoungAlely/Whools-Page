...
import 'package:whools/src/ui/Screens/Home_Desktop/TeamDesktop.dart';
...
class TeamWhools extends StatefulWidget {
  const TeamWhools({super.key, required this.screenSize});
  final Size screenSize;

  @override
  State<TeamWhools> createState() => _TeamWhoolsState();
}

class _TeamWhoolsState extends State<TeamWhools> {
  @override
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
        ...
        child: screenSize.width < 800
                  ...
                  Column(
                    children: [
                      CardTeam(
                        ...
                        tiktok: Icon(FontAwesomeIcons.tiktok),
                      ...
                      CardTeam(
                          ...
                          instagram: const Icon(LineIcons.instagram),
                      ...
                      CardTeam(
                          ...
                          youtube: const Icon(LineIcons.youtube),
                          youtubeUrl:
            ...
            : TeamDesktop(screenSize: screenSize));
  }
}
